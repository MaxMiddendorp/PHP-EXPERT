...
<body>
    <h1 class="mx-auto">Superheroes Index</h1>
    <div class="container">
        <table class="table">
            ...
            <?php foreach ($statement as $item) : ?>
                <tr>
                    ...
                    <td><a href="superheroes_show.php?id=<?php echo $item['ID']; ?>"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-lines-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <td><a href="superheroes_edit.php?id=<?php echo $item['ID']; ?>"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <td><a href="superheroes_delete.php?id=<?php echo $item['ID']; ?>"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
